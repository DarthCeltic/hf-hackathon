...
check the DnCNN output against its uint8 reference hash, require YOLO source
changes to be covered by a fixed image-set output-tensor reference, and require
