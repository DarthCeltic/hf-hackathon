...
def merge_entry(entries: list, score: dict) -> list:
    ...
    new = {
        ...
        "llama_bench_tokens_per_second": score.get("llama_bench_tokens_per_second"),
        "llama_bench_tokens_per_second_stddev": score.get("llama_bench_tokens_per_second_stddev"),
        "llama_bench_prompt_tokens_per_second": score.get("llama_bench_prompt_tokens_per_second"),
        "llama_bench_prompt_tokens_per_second_stddev": score.get("llama_bench_prompt_tokens_per_second_stddev"),
        "llama_bench_prompt_tokens": score.get("llama_bench_prompt_tokens"),
        "llama_bench_generation_tokens": score.get("llama_bench_generation_tokens"),
        "llama_bench_repetitions": score.get("llama_bench_repetitions"),
        "sha": sha,
        "ref": score.get("ref"),
